...
##
Result:
All OTUs were consistently detected across the three replicate pool samples, with no OTUs missing in any replicate. Therefore, there is no evidence of inconsistent detection, and no OTUs need to be removed based on the replicate pool analysis. This indicates good reproducibility and reliability of the sequencing data across replicate pools.